...
public class SteamApiClient : IDisposable
{
    ...
    private record CreateAchievementResponse(AchievementSummary achievement, int success);
    ...
    private record FetchAchievementsResponse(List<AchievementDetails> achievements);
